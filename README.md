...
├── Alson/               # 子睿 的學習筆記
├── Anson/               # 楊逸 的DSE中文科學習筆記
├── Himson/              # Himson 的學習筆記
├── Timothy/             # Timothy 的學習筆記
├── ga_him/              # 家謙 的DSE中文科學習筆記
├── ho_dyun/             # 可端 的學習筆記
├── hok_wai/             # 學維 的DSE中文科學習筆記
├── zeon_lok/            # 浚樂 的DSE中文科學習筆記
├── zeng_han/            # 政行 的DSE中文科學習筆記
...
| 資料夾名稱 | 學生中文名 | 門戶標題 (Title) | DSE 標記狀態 | 備註 / 目錄分類 |
| :--- | :--- | :--- | :---: | :--- |
| `Alson` | 子睿 | 子睿 的學習筆記 | ❌ | 語文基礎與修辭、說話與寫作技巧 |
| `Anson` | 楊逸 | 楊逸 的DSE中文科學習筆記 | ✅ | 閱讀與範文、寫作進階技巧 |
| `Himson` | Himson | Himson 的學習筆記 | ❌ | 記敘文寫作、實用文寫作 |
| `Timothy` | Timothy | Timothy 的學習筆記 | ❌ | 綜合與聆聽訓練、語文適應與翻譯 |
| `ga_him` | 家謙 | 家謙 的DSE中文科學習筆記 | ✅ | DSE 考試策略、寫作進階技巧 |
| `ho_dyun` | 可端 | 可端 的學習筆記 | ❌ | 語文基礎與成語、說話與寫作技巧 |
| `hok_wai` | 學維 | 學維 的DSE中文科學習筆記 | ✅ | 中文科應試與寫作、中國歷史 |
| `zeon_lok` | 浚樂 | 浚樂 的DSE中文科學習筆記 | ✅ | DSE 考試策略、寫作技巧、語文基礎與修辭 |
| `zeng_han` | 政行 | 政行 的DSE中文科學習筆記 | ✅ | DSE 考試策略、寫作進階技巧、語文基礎與修辭 |
